...
public class Const {
    public static long REQUEST_TIME = 1;
    public static String BASE_URL = "http://46.101.146.101:8000/";
    ...
    public synchronized static RoundedBitmapDrawable createRoundedBitmapDrawableWithBorder(Resources resources, Bitmap bitmap) {
        ...
        */
        ...
        borderPaint.setColor(Color.parseColor("#F0F0F0"));
    ...
    public static Shader getGradientColor() {
        return new LinearGradient(0, 120, 0, 150,
                new int[]{Color.BLACK, Color.parseColor("#E0E0E0")},
